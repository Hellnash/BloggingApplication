...
public class JwtHelper {
    ...
    //jwt token expiry default value and secret
    ...
    //1. Set claims, issuer, Expiration, Subject for the token
    //2. Sign the token using the HS512 algorithm and secret key.
